...
class UseCaseRejectVacationRequestTest {
    @Mock
    ...
    void existingRequest_requestStateIsUpdated() throws VacationRequestException {
        ...
        UseCaseRejectVacationRequest usecase = new UseCaseRejectVacationRequest(requestRepository);
        ...
        assertThat(updatedRequest.getState(), is(VacationRequestState.REQUEST_REJECTED));
    }
    ...
    @Test
    void requestAlreadyAccepted_cannotRejectAgain(){
        java.lang.String requestId = "4711";
