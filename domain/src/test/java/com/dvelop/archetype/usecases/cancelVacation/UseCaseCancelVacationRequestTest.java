...
class UseCaseCancelVacationRequestTest {
    @Mock
    ...
    void existingRequest_requestStateIsUpdated() throws VacationRequestException {
        ...
        UseCaseCancelVacationRequest usecase = new UseCaseCancelVacationRequest(requestRepository);
        ...
        assertThat(updatedRequest.getState(), is(VacationRequestState.REQUEST_CANCELLED));
    }
